...
export function render(ctx, ball, leftPaddle, rightPaddle, score, wall) {
	ctx.fillStyle = "black";
	...
	if (wall == "solo_training") { ctx.fillRect(CANVAS_WIDTH - (PADDLE_WIDTH + PADDLE_SPACING), 0, PADDLE_WIDTH, CANVAS_HEIGHT); }
	else { ctx.fillRect(CANVAS_WIDTH - (PADDLE_WIDTH + PADDLE_SPACING), rightPaddle.current.y, PADDLE_WIDTH, PADDLE_HEIGHT); }
